...
_**Tip 1**_: if you want to create a repository for building your own web page by Github, your repositroy's name should be "username.github.io". This detail is very **important** for building your own Github page.

_**Tip 2**_: installing [Github Desktop](https://desktop.github.com/) will help you easily host your works on Github.
