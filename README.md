...
Andrew Etter suggests that a lightweight markup language is better choice than XML for programmers. As a result, Markdown can be a good choice for a new programmer who need a lightwegith markup language. 
